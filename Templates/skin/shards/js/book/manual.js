/**
 * Файл содержит класс модуль управлением и отображением справочника.
 *
 * @author Greg
 * @package book
 */
...
/**
 * Класс модуль управлением и отображением справочника.
 * @constructor {Manual}
 */
Book("Manual", {
	template: '',
	nameBook: '',
	callingWindow: '.btn-manual',
	translations: [],
	cacheTemplate: {
		left: "",
		right: ""
	...
	initialize: function(data){
		/**
		 * Обработчик события клика по кнопке вызова справочника.
		 */
        $('.left-menu').on('click', this.callingWindow, $.proxy(this.showRendering, this));
	},
