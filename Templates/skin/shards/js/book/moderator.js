/**
 * Файл содержит класс модуль управлением и отображением модераторской.
 *
 * @author Greg
 * @package book
 */
...
/**
 * Класс модуль управлением и отображением модераторской.
...
Book("Moderator", {
	...
	initialize: function(data){
		/**
		 * Обработчик события клика по кнопке вызова окна модераторской.
		 */
