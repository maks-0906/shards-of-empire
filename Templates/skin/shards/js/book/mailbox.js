/**
 * Файл содержит класс модуль управлением и отображением почтового ящика пользователя.
 *
 * @author Greg
 * @package book
 */
...
/**
 * Класс модуль управлением и отображением почтового ящика пользователя.
 * @constructor {Mailbox}
 */
Book("Mailbox", {
	template: '',
	...
	initialize: function(data){
		/**
		 * Обработчик события клика по кнопке вызова почтового ящика персонажа.
		 */
