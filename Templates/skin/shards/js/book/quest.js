/**
 * Файл содержит класс модуль управлением и отображением квестами.
 *
 * @author Greg
 * @package book
 */
...
/**
 * Класс модуль управлением и отображением квестами.
 * @constructor {Quest}
 */
Book("Quest", {
	template: '.quest-page',
	nameBook: 'quest-page',
	callingWindow: '.btn-quests',
	translations: [],
	cacheTemplate: {
		left: "",
		right: ""
	},
    init : function(idQuest, callingWindow, loadTemplate)
	{
		if(typeof idQuest != 'undefined') this.attributes['idQuest'] = idQuest;
	...
	initialize: function(data){
		/**
		 * Обработчик события клика по кнопке вызова окна квестов.
		 */
