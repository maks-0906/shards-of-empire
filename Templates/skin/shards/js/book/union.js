/**
 * Файл содержит класс модуль управлением и отображением союзов.
 *
 * @author Greg
 * @package book
 */
...
/**
 * Класс модуль управлением и отображением союзов.
 * @constructor {Union}
 */
Book("Union", {
	template: '',
	...
	initialize: function(data){
		/**
		 * Обработчик события клика по кнопке вызова окна союзов персонажа.
		 */
