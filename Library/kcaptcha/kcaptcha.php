...
class kcaptcha{
	 ...
	 *
	 */
	public function writeCaptchaInTestFile()
	{
		file_put_contents(Engine::GetRootDir().'tests/captcha.txt', $this->keystring);
	}

	/**
	 * @return string
	 */
	public static function getTextCaptchaFromTestFile()
	{
		$pathCaptcha = Engine::GetRootDir().'captcha.txt';
		$captcha = file_get_contents($pathCaptcha);
