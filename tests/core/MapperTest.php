...
abstract class Mapper extends Object {
	 ...
	 * @return array
	 */
	protected function rules() { return array(); }

	/**
	 * Первичный ключ. По умолчанию является `id`.
	 * @return string
	 */
	public function pk(){return 'id';}
	...
	protected static final function __NewConnect()
	{
        ...
        self::$__oDbLink = new mysqli($sDbHost,$sDbUser,$sDbPass,$sDbName);
	...
	{
        if (self::$__oDbLink === null) {self::__NewConnect();}
	 ...
	 */
	protected static final function begin() { self::$__oDbLink->autocommit(false); }
	 ...
	 * @return mixed
	 */
	protected static final function get_insert_id() { return self::$__oDbLink->insert_id; }
	...
	protected static function formatErrors(mysqli $db, Mapper $self)
	{
		switch($db->errno)
		{
			...
			case 1062: $self->errors['unique'] = $db->error; break;

			default:
				$self->errors['main'] = $db->error; break;
		}
	}
	 ...
	 * @return bool
	 */
	public function hasError($typeError){ return isset($this->errors[$typeError]); }

	/**
	 * Утверждение наличия ошибок  после запроса.
	 * @return bool
	 */
	public function isError(){ return count($this->errors) > 0; }
	 ...
	 *
	 */
	public final function GetById() { /* return self::query() */ }
	 ...
	 * @return Mapper
	 */
	public final function delete() { return self::__delete($this); }
	 ...
	 * @deprecated
	 */
	public function isEmptyResult() { return count($this->__DBResult) == 0; }
